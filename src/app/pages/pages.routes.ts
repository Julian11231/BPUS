...
const pagesRoutes: Routes = [
    ...
    {path: "aceptar-proyecto", component:AceptarProyectoComponent, data: {titulo: "Aceptar proyecto"}, canActivate:[PermisosGuard]},
    {
        ...
        children: [
            ...
            { path: "proyectos-asignados", component: TutoriaProyectoComponent, data: { titulo: "Proyectos Asignados" } ,canActivate: [PermisosGuard]},
            ...
            { path: "inscripcion-proyecto", component:InscripcionProyectoComponent, data: {titulo: "Inscripción del proyecto"}, canActivate:[PermisosGuard]},
